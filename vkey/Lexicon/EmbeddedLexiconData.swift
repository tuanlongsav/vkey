//
//  EmbeddedLexiconData.swift
//  vkey
//
//  Vietnamese (7184), English (126) and keep-word datasets bundled into the
//  app binary. Extracted from InputProcessor.swift in 1.5.0 as part of the
//  Phase 3 module split — the data alone was ~7200 lines and made the
//  InputProcessor file unmaintainable.
//
//  Attribution (kept here so it travels with the data):
//  - Vietnamese syllables: @hieuthi / common-vietnamese-syllables
//    https://github.com/vietnameselanguage/syllable
//    https://gist.github.com/hieuthi/1f5d80fca871f3642f61f7e3de883f3a
//  - 1.5.0 extensions credit Wiktionary / Kaikki.org and wordfreq —
//    see CHANGELOG.md and README.md "Ghi công" section.
//

import Foundation

/// Embedded data shipped inside the app binary. `internal` (no `private`)
/// since 1.5.0 so the rest of the Lexicon module can reach the constants.
struct EmbeddedLexiconData {
